...
class Mod(commands.Cog):
  ...
  async def setonline(self, ctx):
    ...
    embed = discord.Embed(color=orange, title="Set Hu Tao's status to",description='`Online`')
    await ctx.send(embed=embed)
  @commands.command()
  @commands.has_permissions(administrator=True)
  async def setidle(self, ctx):
    await ctx.bot.change_presence(status=discord.Status.idle)
    embed = discord.Embed(color=orange, title="Set Hu Tao's status to",description='`Idle`')
    await ctx.send(embed=embed)
  @commands.command()
  @commands.has_permissions(administrator=True)
  async def setdnd(self, ctx):
    await ctx.bot.change_presence(status=discord.Status.dnd)
    embed = discord.Embed(color=orange, title="Set Hu Tao's status to",description='`Do not disturb`')
    await ctx.send(embed=embed)
  @commands.command()
  @commands.has_permissions(administrator=True)
  async def setinv(self, ctx):
    await ctx.bot.change_presence(status=discord.Status.invisible)
    embed = discord.Embed(color=orange, title="Set Hu Tao's status to",description='`Invisible`')
    await ctx.send(embed=embed)
  ...
  async def actplaying(self, ctx, *, name):
    ...
    embed = discord.Embed(color=orange,title="Set Hu Tao's activity to",description=f'`playing {name}`')
    await ctx.send(embed=embed)
  @commands.command()
  @commands.has_permissions(administrator=True)
  async def actlistening(self, ctx, *, name):
    ...
    embed = discord.Embed(color=orange, title="Set Hu Tao's activity to",description=f'`listening {name}`')
    await ctx.send(embed=embed)
  @commands.command()
  @commands.has_permissions(administrator=True)
  async def actwatching(self, ctx, *, name):
    ...
    embed = discord.Embed(color=orange,title="Set Hu Tao's activity to",description=f'`watching {name}`')
    await ctx.send(embed=embed)
  @commands.command()
  @commands.has_permissions(administrator=True)
  async def actcompeting(self, ctx, *, name):
    ...
    embed = discord.Embed(color=orange, title="Set Hu Tao's activity to",description=f'`competing in {name}`')
    await ctx.send(embed=embed)
